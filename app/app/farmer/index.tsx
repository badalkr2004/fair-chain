...
const crops = [
  {
    ...
    predictedPrice: '₹45-50/kg',
    image: 'https://images.unsplash.com/photo-1626426336803-0fb815b51502?w=800&auto=format&fit=crop'
  },
  {
    id: '2',
    name: 'Wheat',
    ...
    quantity: '1.8 tons',
    status: 'Growing',
    predictedPrice: '₹32-36/kg',
    image: 'https://images.unsplash.com/photo-1534806093278-33f63e2fab5b?w=800&auto=format&fit=crop'
  },
  {
    id: '3',
    name: 'Tomatoes',
    ...
    quantity: '800 kg',
    status: 'Ready for harvest',
    predictedPrice: '₹20-25/kg',
    image: 'https://images.unsplash.com/photo-1544977446-f5efd38109c3?w=800&auto=format&fit=crop'
  }
];
        ...
        <View className="px-6 pt-16">
          <View className="flex-row justify-between items-center mb-8">
            <View>
              ...
              <Text className="text-gray-600">Welcome back, Rajesh Kumar</Text>
            </View>
            <TouchableOpacity 
          ...
          >
            ...
            <View className="flex-row justify-between">
              <View className="bg-white/20 rounded-lg p-3 flex-1 mr-2">
                ...
                <Text className="text-white font-semibold">Rabi</Text>
              </View>
              <View className="bg-white/20 rounded-lg p-3 flex-1 mr-2">
              ...
              <View className="bg-white/20 rounded-lg p-3 flex-1">
                <Text className="text-white text-xs mb-1">Potential Revenue</Text>
                <Text className="text-white font-semibold">₹125,000</Text>
              </View>
            </View>
          </Animated.View>
              ...
              >
                ...
                <View className="p-4">
                  ...
                  <View className="flex-row items-center justify-between mt-2">
                    <Text className="text-gray-500">Predicted market price:</Text>
          ...
          <Animated.View entering={FadeInDown.delay(800).duration(500)}>
            ...
            <View className="bg-white rounded-xl p-4 mb-3 shadow-sm">
              <View className="flex-row justify-between items-center mb-3">
                <Text className="font-medium text-gray-800">Rice Batch #RB-2023-42</Text>
                <View className="bg-blue-100 px-2 py-1 rounded-full">
                  <Text className="text-blue-700 text-xs">In Transit</Text>
                </View>
              </View>
              <View className="flex-row items-center">
                ...
                <View className="h-1 w-8 bg-green-600" />
                <View className="h-1 w-8 bg-gray-300 rounded-r-full" />
              </View>
            ...
            <View className="bg-white rounded-xl p-4 shadow-sm">
              <View className="flex-row justify-between items-center mb-3">
                <Text className="font-medium text-gray-800">Tomato Batch #TB-2023-16</Text>
                <View className="bg-green-100 px-2 py-1 rounded-full">
              ...
              <View className="flex-row items-center">
                ...
                <View className="h-1 w-8 bg-green-600" />
                <View className="h-1 w-8 bg-green-600" />
                <View className="h-1 w-8 bg-green-600 rounded-r-full" />
              </View>
              <View className="flex-row justify-between mt-2">
                <Text className="text-xs text-gray-500">Farm</Text>
                <Text className="text-xs text-gray-500">Processing</Text>
